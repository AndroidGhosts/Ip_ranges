...
def print_ascii_art():
    ascii_art_text = pyfiglet.figlet_format('Android Ghosts', font='small')
...
def select_target_hosts():
    ...
    console.print("Choose the target host for scanning:")
...
def main():
    ...
    print_ascii_art()
    console.print(emoji.emojize(':satellite: Initiating Android Ghosts Host Analysis :satellite:'))
